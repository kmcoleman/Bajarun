 ...
 * LoginPage.tsx
 *
 * Login/Create Account page with email/password and Google options.
 */
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-8">
          ...
          <p className="text-slate-400 text-center mb-8">
            {isCreateAccount
              ? 'Create an account to register for the Baja Tour'
              : 'Sign in to access registration and discussions'}
          </p>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
                  />
                </div>
              </div>
            )}
